"""S&P 500 constituents (github datasets/s-and-p-500-companies, fetched 26 Sep 2026)
for the Markets US panel. Static on purpose: the index changes a handful of names
a quarter; re-fetch when it drifts. (symbol, name, GICS sector)."""
SP500 = (
    ("MMM", "3M", "Industrials"),
