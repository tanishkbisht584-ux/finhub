@echo off
rem FinFlick Admin one-click launcher: (re)start the server on port 8787 and open it.
...
start "FinFlick Admin" /min cmd /c ""%PYEXE%" -m streamlit run admin/app.py --server.port 8787"
timeout /t 3 >nul
