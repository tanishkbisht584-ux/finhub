...
SECRETS = [
    ...
    dict(name="SUPABASE_ACCESS_TOKEN", group="Supabase", shape="single", probe="mgmt",
         targets={"env": True, "toml": True, "gh": True},
         readers="admin (Doctor › Schema, Storage flush/vacuum, edge-secret sync); watchdog (CI) storage self-heal",
         console="https://supabase.com/dashboard/account/tokens",
         note="Personal access token (sbp_…), Management API. Project-scoped, long expiry — the 30-day one expired on 22 Sep and blocked three migrations."),
