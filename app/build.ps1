# FinFlick release build — the ONLY way to build an APK for install.
...
Write-Host "Building FinFlick v$version..."
...
$out = "$env:USERPROFILE\Desktop\finflick-v$version.apk"
